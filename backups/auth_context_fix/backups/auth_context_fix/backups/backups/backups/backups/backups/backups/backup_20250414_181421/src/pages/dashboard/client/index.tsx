                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-xl overflow-hidden">
                    <img 
                      ...
                      alt={`${appointment.professional.user.first_name || user.first_name} ${appointment.professional.user.lastName || user.last_name}`}
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="ml-3">
                    <h3 className="font-medium">{appointment.professional.user.first_name || user.first_name} {appointment.professional.user.lastName || user.last_name}</h3>
