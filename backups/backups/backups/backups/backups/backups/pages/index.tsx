  ...
  return (
    ...
    >
      ...
      <div className="p-4 -mt-10 relative">
        ...
        <p className="text-sm text-purple-700 font-medium mb-2">{professional.specialties?.join(', ') || professional.specialty}</p>
        ...
        {professional.offers_home_service && (
  ...
  useEffect(() => {
    async function loadProfessionals() {
      try {
        ...
        // Convertendo filtros para o formato esperado pela API
        const apiFilters = {
          zone: filters.zone || undefined,
          district: filters.district || undefined,
          category: filters.service || undefined,
          homeService: filters.homeService || undefined
        };
        
        const response = await professionalService.getProfessionals(apiFilters);
