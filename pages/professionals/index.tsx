...
export default function ProfessionalsList() {
  ...
  const filteredProfessionals = professionals.filter((prof) => {
    if (activeFilters.zone && prof.location.zone !== activeFilters.zone) return false;
    if (activeFilters.homeService && !prof.homeService) return false;
    if (activeFilters.rating > 0 && prof.rating < activeFilters.rating) return false;
    return true;
  });

  // Componente de cartão de profissional
      ...
      <div className="bg-white p-4 rounded-xl mb-4 shadow-sm">
        ...
        <div className="mt-3 pt-3 border-t border-gray-100">
          ...
          <div className="flex justify-between">
            <div className="text-sm">{professional.services[0]?.name}</div>
  ...
  return (
    <MainLayout title="Profissionais | Agenda Livre">
      <Head>
      ...
      <div className="bg-white py-3 px-4 flex justify-between items-center sticky top-0 z-10 border-b">
        ...
        >
          ...
          Filtros{' '}
          {activeFilters.zone || activeFilters.homeService || activeFilters.rating > 0
